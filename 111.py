...
class ImageBase64Converter:
    def __init__(self, root):
        self.root = root
        self.root.title("图片与Base64转换器(加密)")
    ...
    def browse_image(self):
        ...
        if file_path:
            ...
            if file_size > 10:  # 限制图片大小为 10MB
                messagebox.showwarning("警告", "图片文件过大，请选择小于 10MB 的图片。")
                return
            self.image_path_entry.delete(0, tk.END)
            self.image_path_entry.insert(0, file_path)
            self.convert_image_to_base64(file_path)

    def encrypt_base64(self, base64_code):
        """加密 Base64 代码"""
        # 简单的字符替换加密
        encrypted_code = base64_code.translate(str.maketrans(
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
            "ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba9876543210+/"
        ))
        return encrypted_code

    def decrypt_base64(self, encrypted_code):
        """解密 Base64 代码"""
        # 解密字符替换
        base64_code = encrypted_code.translate(str.maketrans(
            "ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba9876543210+/",
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
        ))
        return base64_code
    ...
    def convert_image_to_base64(self, image_path):
        ...
        try:
            ...
            # 加密 Base64 代码
            encrypted_code = self.encrypt_base64(base64_code)
    ...
    def preview_image(self):
        ...
        try:
            ...
            # 解密 Base64 代码
            base64_code = self.decrypt_base64(encrypted_code)
